module github.com/libercapital/rabbitmq-client-go/v3
...
require (
	...
	github.com/libercapital/liber-logger-go v1.1.0
	github.com/rabbitmq/amqp091-go v1.9.0
	github.com/stretchr/testify v1.8.4
	gitlab.com/bavatech/architecture/software/libs/go-modules/rabbitmq-client.git/v3 v3.8.1
...
require (
	...
	gitlab.com/bavatech/architecture/software/libs/go-modules/bavalogs.git v0.6.1-pre.2 // indirect
